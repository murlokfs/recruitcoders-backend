...
urlpatterns = [
    ...
    path(
        ...
        name="candidatura-confirm-page",
    ),
    path("candidaturas", CandidaturaListView.as_view(), name="candidaturas"),
    path(
        "candidatura/<int:pk>/deletar",
        CandidaturaDeleteView.as_view(),
        name="candidatura-delete-page",
    ),
    path("curriculo", CurriculoCreateView.as_view(), name="curriculo"),
    path(
        "curriculo/<int:pk>/editar",
        CurriculoUpdateView.as_view(),
        name="curriculo-update",
    ),
    path("dashboard/", DashboardListView.as_view(), name="dashboard"),
    path(
        "dashboard/vaga/<int:pk>",
        DashboardCandidaturasListView.as_view(),
        name="dashboard-vaga-view",
    ),
    path(
        "dashboard/vaga/criar",
        DashboardCreateView.as_view(),
        name="dashboard-vaga-criar",
    ),
    path(
        "dashboard/vaga/<int:pk>/editar",
        DashboardUpdateView.as_view(),
        name="dashboard-vaga-editar",
    ),
    path(
        "dashboard/vaga/<int:pk>/deletar",
        DashboardDeleteView.as_view(),
        name="dashboard-vaga-deletar",
    ),
