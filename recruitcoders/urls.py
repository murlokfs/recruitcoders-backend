...
from vagas.views import Index, VagaListView, VagaDetailView, CandidaturaListView, CurriculoCreateView, CurriculoUpdateView, CandidaturaCreateView, CandidaturaDeleteView
...
urlpatterns = [
    ...
    path('candidatura/<int:pk>/delete', CandidaturaDeleteView.as_view(), name='candidatura-delete-page'),
